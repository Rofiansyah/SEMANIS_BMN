...
export default function EnhancedReturnModal({ 
  ...
  useEffect(() => {
    if (!isOpen) {
      ...
      setLokasiId(peminjaman.barang.lokasi.id);
    }
  }, [isOpen, peminjaman]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // ✅ Update barang dulu dengan lokasi baru
      await barangApi.update(peminjaman!.barang.id, {
        nama: peminjaman!.barang.nama,
        deskripsi: peminjaman!.barang.deskripsi || '',
        kategoriId: peminjaman!.barang.kategori.id,
        merekId: peminjaman!.barang.merek.id,
        lokasiId: lokasiId,
