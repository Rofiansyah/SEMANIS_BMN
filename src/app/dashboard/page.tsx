  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen px-4 bg-gray-50">
      ...
      <div className="relative w-20 h-20 sm:w-24 sm:h-24 md:w-28 md:h-28 flex items-center justify-center mb-6">
        ...
        <Package className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 text-indigo-700 animate-bounce" />
      </div>

      {/* Teks animasi */}
      <p className="text-lg sm:text-xl md:text-2xl font-bold text-indigo-700 animate-pulse text-center">
        Mengalihkan ke dashboard admin...
      </p>

      {/* Progress Bar */}
      <div className="w-48 sm:w-56 md:w-64 h-2 bg-gray-200 rounded-full mt-6 overflow-hidden">
        <div className="h-2 bg-indigo-600 rounded-full animate-[progress_2s_ease-in-out_infinite]"></div>
      </div>
