    ...
    <div className="space-y-6">
      ...
      <div className="relative max-w-md w-full">
        ...
        <input
          ...
          className="w-full p-3 w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:border-blue-950 bg-white text-gray-900 placeholder-gray-500"
        />
      </div>
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[500px]">
              <thead className="bg-gray-50">
                <tr>
                  <th className="text-left py-3 px-4 sm:px-6 font-medium text-gray-900">
                    Nama Lokasi
                  </th>
                  <th className="text-left py-3 px-4 sm:px-6 font-medium text-gray-900">
                    Tanggal Dibuat
                  </th>
                  <th className="text-center py-3 px-4 sm:px-6 font-medium text-gray-900">
                    Aksi
                  </th>
                </tr>
              </thead>
