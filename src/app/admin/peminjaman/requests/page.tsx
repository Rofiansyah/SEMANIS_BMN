      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
        {filteredRequests.map((request) => {
          ...
          return (
            <div
              key={request.id}
              className={`rounded-2xl border shadow-sm hover:shadow-md transition-all duration-200 overflow-hidden ${statusInfo.bgColor}`}
            >
              {/* Header Card */}
              ...
              <div className="p-4 space-y-3 text-sm text-gray-700">
                <div>
                  ...
                  <p className="font-semibold">{request.barang.nama}</p>
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  ...
                  <div>
                    <p className="text-gray-500">Tanggal Dipinjam</p>
                    <p className="font-medium">
                ...
                <div className="grid grid-cols-2 gap-3 text-xs">
                  <div>
                    <p className="text-gray-500">Lama Pinjam</p>
                    <p className="font-medium">
                  ...
                  <div>
                    ...
                    <p className="font-medium">{request.penanggungJawab || '-'}</p>
                  </div>
                </div>
                ...
                {request.status === 'PENDING' && (
                  <>
                    <Button
                      ...
                      className="flex items-center justify-center border-2 border-gray-300 hover:border-blue-900 hover:bg-blue-50 transition"
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        size="sm"
                        variant="outline"
                        className="flex-1 flex items-center justify-center bg-blue-950 hover:bg-blue-900 text-white"
                ...
                {request.status === 'DIPINJAM' && (
                  <>
                    ...
                    <Button
                      size="sm"
                      variant="outline"
                      className="flex items-center justify-center bg-blue-950 hover:bg-blue-900 text-white"
