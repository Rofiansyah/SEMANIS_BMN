...
<tbody className="divide-y divide-gray-200">
  {filteredBarang.map((barang) => {
    const kondisiBg: Record<string, string> = {
      "Rusak Berat": "bg-red-50",
      "Baik": "bg-green-50",
      "Rusak Ringan": "bg-green-50",
    };

    return (
      <tr
        key={barang.id}
        className={`rounded-2xl border p-6 shadow-sm hover:shadow-md transition-all duration-200 ${kondisiBg[barang.kondisi] || ""}`}
      >
        {/* Foto + Nama Barang */}
