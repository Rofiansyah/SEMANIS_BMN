    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div className="flex items-center space-x-4">
          ...
          <div>
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900 truncate max-w-[250px] sm:max-w-none">
              {barang.nama}
            </h1>
            ...
            <div className="p-4 sm:p-6 space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <span
                    className={`inline-flex items-center px-3 py-1 text-xs sm:text-sm font-medium rounded-full border ${
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 text-gray-900">
                    ...
                    <span className="truncate">{barang.kategori.nama}</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex items-center space-x-2 text-gray-900">
                    ...
                    <span className="truncate">{barang.merek.nama}</span>
                  </div>
                </div>
              ...
              <div>
                ...
                <p className="text-gray-900 bg-gray-50 p-3 rounded-lg text-sm sm:text-base leading-relaxed">
          ...
          <div className="bg-white rounded-2xl shadow-md border overflow-hidden">
            ...
            <div className="p-4 sm:p-6">
              {barang.fotoUrl ? (
                ...
                <div className="flex flex-col items-center justify-center aspect-video bg-gray-50 rounded-lg border-2 border-dashed border-gray-300">
